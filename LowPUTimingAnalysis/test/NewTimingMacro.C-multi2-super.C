...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   // random events method 1+1+1 ...Michael-Jonathan's method
  ...
  // random events method 2+1 ...Michael-Jonathan's method
   ...
   */
   ...
   TFile *fx = new TFile("output2017_LowPU_.root","RECREATE");
   h01->Write();
   h02->Write();
   h1->Write();
   h2->Write();
